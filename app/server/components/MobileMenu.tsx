  ...
  return (
    <>
      ...
      <Button
        variant="ghost"
        size="icon"
        className="sm:hidden primary-text hover:accent-color focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 focus-visible:ring-offset-background"
        onClick={toggleMenu}
      >
        <Menu size={20} />
      ...
      {isMenuOpen && (
        <div className="absolute overflow-y-scroll 500 h-[calc(100vh-64px)] inset-x-0 top-[4rem] sm:hidden z-[100] w-full">
