...
import { LayoutCounter } from './client/LayoutCounter';
    ...
    <>
        <div className="p-6 border border-green-500 border-dashed rounded-lg">
              ...
              <nav className="flex p-4 my-4 space-x-4">
                <Link href="/docs/file-conventions/template/demo-layout" className="text-blue-400 hover:text-blue-300">Go to Page One</Link>
                <Link href="/docs/file-conventions/template/demo-layout/page-two" className="text-blue-400 hover:text-blue-300">Go to Page Two</Link>
              </nav>
