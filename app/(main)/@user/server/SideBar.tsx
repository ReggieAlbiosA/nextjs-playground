    ...
    import { SidebarWrapper } from "./client/SidebarWrapper";
    ...
    export function SideBar({ initialMode }: { initialMode: string }) {
        ...
        return (
            <aside aria-label="Sidebar Navigation">
                {/* * Render the new client wrapper.
                * Pass the RAW, UNMODIFIED navigation items to it.
                * The wrapper will handle the state and dynamic link generation.
                */}
                <SidebarWrapper
                    initialMode={initialMode}
                    logo={<SiteLogo />}
                    buildingItems={buildingYourApplicationItems}
                    apiItems={apiReferenceItems}
                />
            </aside>
        );
    }